package com.felpslipe.cabela_mayhem.block.client;
...
public class CabelaSkullModel extends SkullModelBase {
    public static final ModelLayerLocation CABELA_HEAD = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(CabelaMayhem.MOD_ID, "cabela_head"), "main");
